  ...
  return (
    <main className="  h-screen w-full flex flex-col justify-start items-center font-helvetica text-morning ">
      <div className=" w-full flex flex-col justify-start items-center font-helvetica text-morning bg-footer">
        <div className="container text-5xl font-extrabold my-20 w-full flex justify-center items-center mr-36 ">
          <h1>Let’s start</h1>
        </div>
        {/* section 2 */}
        <div className=" container flex justify-between items-center ">
          ...
          <div>
            <article className="flex justify-between items-center text-3xl">
              <div className="clock mx-5">
        ...
        <hr className="mt-20 w-full container border-t-2 border-morning" />
        {/* social links */}
      ...
      {/* section comment */}
      <div className=" bg-morning h-full w-full flex flex-col justify-start items-center text-primary py-20">
        <h1 className="text-3xl font-bold">“Without creativity we fail.”</h1>
        <hr className="mt-20 w-full container border-t-2 border-primary" />
        <div className="bg-action py-3  text-center flex justify-center font-bold">
          <span className="flex justify-center items-center desktop:text-lg mobile:text-xs">
            ...
            By{' '}
            <a
              className="desktop:text-lg mobile:text-xs text-footer  mx-1 flex justify-center"
